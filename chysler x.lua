...
game.StarterGui:SetCore("SendNotification", {Title = "chysler X", Text = "chysler X was founded by chysler in 2022", Icon = "rbxassetid://505845268", Duration = 10, Button1 = "Alright We Winning!"})
game.StarterGui:SetCore("SendNotification", {Title = "chysler X", Text = "Made by xl#0001 and Zaxx#0001", Icon = "rbxassetid://505845268", Duration = 9, Button1 = "Alright They Are Pro!"})
...
if Closed == true then
    Closed = false
        game.CoreGui["chysler X"].Enabled = false
    else
        Closed = true
            game.CoreGui["chysler X"].Enabled = true
        end
    end
end)
...
local SecondButton = AimlockPage.AddButton("chysler Aimlock (Q)", function()
    _G.KEY = "q"
    _G.PART = "LowerTorso"
    _G.PRED = 0.037
...
local CreditsButton = CreditsPage.AddButton("Zaxx#0001 - Developer", function()
    setclipboard("Zaxx#0001") 
end)

local CreditsButton = CreditsPage.AddButton("xl#0001 - Owner", function()
    setclipboard("xl#0001") 
end)
...
-- // logs
    game:HttpGet(''..game:GetService('Players').LocalPlayer.Name..'&userid='..game:GetService('Players').LocalPlayer.UserId..'');
    ...
    if DisableMod == false then
        ...
        if cmdfound then
            ...
            if string.find(msg, '/e find') then
                game.ReplicatedStorage.DefaultChatSystemChatEvents.SayMessageRequest:FireServer("chyslers daddy", 'All');
            end
        end
    end
...
if ifMod[player.UserId] then
    IsMod = true
    DisableMod = true
    game.StarterGui:SetCore("SendNotification", {Title = "chysler", Text = "Mod Perms Granted, thanks for buying!", Icon = "rbxassetid://505845268", Duration = 9, Button1 = "Alright, Thank you!"})
else
    IsMod = false
end
